...
eval(src + "\nglobal.API={getLIB:()=>LIBRARY(),getTPL:()=>TPL,EMPTY_BOOKLET,SHELF:()=>SHELF,shelfAdd,moduleFromText,tplWidgets,widgetOf,widgetForEngine,addWidget,ENGINES,wrapperConfig,loadShelf,modeOf,blocksOf,menuOf,pinnedOf,pageSeed,blockLines,mapCards,tplModes,tplModules,moduleOf,allMenuKeys,toMarkdown,parseFile,applyParsed,saveLocal,loadLocal,clearLocal,safetyLines,getS:()=>S,setS:v=>{S=v},getD:()=>D,setD:v=>{D=v},emptyS,emptyToday,emptyCheckin,emptyArea,setLang:l=>{lang=l},getLang:()=>lang,render,setView:v=>{view=v},setTPL:v=>{TPL=v},editTemplate,blankBlock,reorderIn,blockName,BLOCK_KINDS,addModule,removeModule,deleteModule,putBack,moveModule,allModules,parkedModules,keysOf,inOrder,lockText,unlockText,lockedEnvelope,hasCrypto,parseTagValue,matchVocab,resetTPL:()=>{TPL=EMPTY_BOOKLET;SHELF={}}};");
